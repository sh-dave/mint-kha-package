...
var SkinnedExample = function() {
	this.theme = mintkha_theme_KenneyBasicTheme.blueTheme;
	this.progressValue = 0.0;
	kha_System.init("mintkha-example-atlas",512,512,$bind(this,this.system_initializedHandler));
};
$hxClasses["SkinnedExample"] = SkinnedExample;
SkinnedExample.__name__ = true;
SkinnedExample.prototype = {
	backbuffer: null
	,rendering: null
	,focusManager: null
	,themeAtlasModel: null
	,themeAtlasTexture: null
	,canvas: null
	,progress: null
	,pressMeButton: null
	,checkbox: null
	...
	,progressValue: null
	,theme: null
	,system_initializedHandler: function() {
		kha_Assets.loadEverything($bind(this,this.assets_loadedHandler));
	}
	,assets_loadedHandler: function() {
		this.setupTheme();
		this.setupUi();
		this.setupUiEvents();
	...
	,update: function() {
		...
		if(this.progressValue >= 1.0) this.progressValue -= 1.0;
		this.progress.set_progress(this.progressValue);
	}
	,render: function(framebuffer) {
		var g = this.backbuffer.get_g2();
		g.begin(true,kha__$Color_Color_$Impl_$.fromBytes(0,64,64));
		this.rendering.renderG2(g);
		g.end();
		g = framebuffer.get_g2();
		g.begin();
		kha_Scaler.scale(this.backbuffer,framebuffer,kha_System.get_screenRotation());
		g.end();
	}
	,setupTheme: function() {
		this.themeAtlasModel = mintkha_support_StarlingAtlasXmlReader.read(Xml.parse(kha_Assets.blobs.basic_atlas_xml.toString()));
		this.themeAtlasTexture = kha_Assets.images.basic_sheet;
	}
	,pressMeButton_onClickHandler: function(_1,_2) {
		this.checkbox.set_state(!this.checkbox.state);
	}
	,setupUi: function() {
		this.backbuffer = kha_Image.createRenderTarget(512,512);
		this.rendering = new mintkha_G2Rendering();
		this.canvas = new mint_Canvas({ rendering : this.rendering, mouse_input : true, key_input : true});
		var a = kha_Assets;
		this.focusManager = new mint_focus_Focus(this.canvas);
		this.pressMeButton = new mint_Button({ parent : this.canvas, x : 128, y : 128, w : 128, h : 64, text : "PRESS ME!", align : 3, align_vertical : 3, text_size : 9, bounds_wrap : true, onclick : $bind(this,this.pressMeButton_onClickHandler), options : { defaultSkin : mintkha_ThemeTools.nineSliceSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.buttonUpSkinId,this.theme.buttonNineSliceGrid), highlightSkin : mintkha_ThemeTools.nineSliceSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.buttonHoverSkinId,this.theme.buttonNineSliceGrid), downSkin : mintkha_ThemeTools.nineSliceSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.buttonDownSkinId,this.theme.buttonNineSliceGrid,this.theme.buttonDownOffset), disabledSkin : mintkha_ThemeTools.nineSliceSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.buttonDisabledSkinId,this.theme.buttonNineSliceGrid), label : { defaultSkin : new mintkha_skin_LabelSkin(kha__$Color_Color_$Impl_$._new(-16043204),kha_Assets.fonts.kenvector_future_thin,16,"PRESS ME!",new mintkha_support_Offset(16,16)), highlightSkin : new mintkha_skin_LabelSkin(kha__$Color_Color_$Impl_$._new(-16043204),kha_Assets.fonts.kenvector_future_thin,16,"PRESS ME!",new mintkha_support_Offset(16,16)), downSkin : new mintkha_skin_LabelSkin(kha__$Color_Color_$Impl_$._new(-16043204),kha_Assets.fonts.kenvector_future_thin,16,"PRESS ME!",new mintkha_support_Offset(16,21)), disabledSkin : new mintkha_skin_LabelSkin(kha__$Color_Color_$Impl_$._new(-10786960),kha_Assets.fonts.kenvector_future_thin,16,"PRESS ME!",new mintkha_support_Offset(16,16))}}});
		this.checkbox = new mint_Checkbox({ parent : this.canvas, x : 384, y : 128, w : 38, h : 36, state : true, options : { defaultSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.checkUpSkinId), highlightSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.checkHoverSkinId), downSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.checkDownSkinId), disabledSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.checkDisabledSkinId), selectedDefaultSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.checkSelectedUpSkinId), selectedHighlightSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.checkSelectedHoverSkinId), selectedDownSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.checkSelectedDownSkinId), selectedDisabledSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.checkSelectedDisabledSkinId)}});
		this.progress = new mint_Progress({ parent : this.canvas, x : 128, y : 256, w : 128, h : 16, options : { backgroundSkin : new mintkha_skin_ColoredRectSkin(kha__$Color_Color_$Impl_$.fromBytes(128,128,128)), fillSkin : new mintkha_skin_ColoredRectSkin(kha__$Color_Color_$Impl_$.Green), paddingTop : 4, paddingBottom : 4, paddingRight : 4, paddingLeft : 4}});
		this.slider = new mint_TrackSlider({ parent : this.canvas, x : 128, y : 384, w : 256, h : 32, minimumValue : 0, maximumValue : 100, value : 25, trackOptions : { text : null, x : 0, y : 15, w : 256, h : 2, options : { defaultSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.sliderTrackDefaultSkinId), highlightSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.sliderTrackDefaultSkinId), downSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.sliderTrackDefaultSkinId), disabledSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.sliderTrackDefaultSkinId), label : { }}}, handleOptions : { text : null, w : 28, h : 42, options : { defaultSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.sliderHandleUpSkinId), highlightSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.sliderHandleHoverSkinId), downSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.sliderHandleDownSkinId), disabledSkin : mintkha_ThemeTools.textureSkin(this.themeAtlasTexture,this.themeAtlasModel,this.theme.sliderHandleDisabledSkinId), label : { }}}});
	}
	,get_fbw: function() {
	...
	,setupUiEvents: function() {
		var _g = this;
		var bbw = this.backbuffer.get_width();
		var bbh = this.backbuffer.get_height();
		kha_input_Mouse.get(0).notify(function(button,x,y) {
			_g.canvas.mousedown({ timestamp : kha_System.get_time(), state : 2, button : 0, x : kha_Scaler.transformXDirectly(x,y,kha_System.get_pixelWidth(),kha_System.get_pixelHeight(),bbw,bbh,kha_System.get_screenRotation()), y : kha_Scaler.transformYDirectly(x,y,kha_System.get_pixelWidth(),kha_System.get_pixelHeight(),bbw,bbh,kha_System.get_screenRotation()), yrel : 0, xrel : 0, bubble : true});
		},function(button1,x1,y1) {
			_g.canvas.mouseup({ timestamp : kha_System.get_time(), state : 3, button : 0, x : kha_Scaler.transformXDirectly(x1,y1,kha_System.get_pixelWidth(),kha_System.get_pixelHeight(),bbw,bbh,kha_System.get_screenRotation()), y : kha_Scaler.transformYDirectly(x1,y1,kha_System.get_pixelWidth(),kha_System.get_pixelHeight(),bbw,bbh,kha_System.get_screenRotation()), yrel : 0, xrel : 0, bubble : true});
		},function(x2,y2,movementX,movementY) {
			_g.canvas.mousemove({ timestamp : kha_System.get_time(), state : 4, button : -1, x : kha_Scaler.transformXDirectly(x2,y2,bbw,bbh,kha_System.get_pixelWidth(),kha_System.get_pixelHeight(),kha_System.get_screenRotation()), y : kha_Scaler.transformYDirectly(x2,y2,bbw,bbh,kha_System.get_pixelWidth(),kha_System.get_pixelHeight(),kha_System.get_screenRotation()), yrel : movementX, xrel : movementY, bubble : true});
		},function(delta) {
		});
	}
	,__class__: SkinnedExample
};
var Main = function() { };
$hxClasses["Main"] = Main;
Main.__name__ = true;
...
var kha_ImageList = function() {
	this.space_sheetDescription = { files : ["space-sheet.png"], original_height : 512, type : "image", original_width : 512, name : "space_sheet"};
	this.space_sheetName = "space_sheet";
	this.space_sheet = null;
	this.basic_sheetDescription = { files : ["basic-sheet.png"], original_height : 1024, type : "image", original_width : 1024, name : "basic_sheet"};
	this.basic_sheetName = "basic_sheet";
	this.basic_sheet = null;
};
$hxClasses["kha.ImageList"] = kha_ImageList;
kha_ImageList.__name__ = true;
kha_ImageList.prototype = {
	basic_sheet: null
	,basic_sheetName: null
	,basic_sheetDescription: null
	,basic_sheetLoad: function(done) {
		kha_Assets.loadImage("basic_sheet",function(image) {
			done();
		});
	}
	,basic_sheetUnload: function() {
		this.basic_sheet.unload();
		this.basic_sheet = null;
	}
	,space_sheet: null
	,space_sheetName: null
	,space_sheetDescription: null
	,space_sheetLoad: function(done) {
		kha_Assets.loadImage("space_sheet",function(image) {
			done();
		});
	}
	,space_sheetUnload: function() {
		this.space_sheet.unload();
		this.space_sheet = null;
	}
...
var kha_BlobList = function() {
	this.space_atlas_xmlDescription = { files : ["space-atlas.xml"], type : "blob", name : "space_atlas_xml"};
	this.space_atlas_xmlName = "space_atlas_xml";
	this.space_atlas_xml = null;
	this.basic_atlas_xmlDescription = { files : ["basic-atlas.xml"], type : "blob", name : "basic_atlas_xml"};
	this.basic_atlas_xmlName = "basic_atlas_xml";
	this.basic_atlas_xml = null;
};
$hxClasses["kha.BlobList"] = kha_BlobList;
kha_BlobList.__name__ = true;
kha_BlobList.prototype = {
	basic_atlas_xml: null
	,basic_atlas_xmlName: null
	,basic_atlas_xmlDescription: null
	,basic_atlas_xmlLoad: function(done) {
		kha_Assets.loadBlob("basic_atlas_xml",function(blob) {
			done();
		});
	}
	,basic_atlas_xmlUnload: function() {
		this.basic_atlas_xml.unload();
		this.basic_atlas_xml = null;
	}
	,space_atlas_xml: null
	,space_atlas_xmlName: null
	,space_atlas_xmlDescription: null
	,space_atlas_xmlLoad: function(done) {
		kha_Assets.loadBlob("space_atlas_xml",function(blob) {
			done();
		});
	}
	,space_atlas_xmlUnload: function() {
		this.space_atlas_xml.unload();
		this.space_atlas_xml = null;
	}
	,__class__: kha_BlobList
};
var kha_FontList = function() {
	this.kenvector_future_thinDescription = { files : ["kenvector_future_thin.ttf"], type : "font", name : "kenvector_future_thin"};
	this.kenvector_future_thinName = "kenvector_future_thin";
	this.kenvector_future_thin = null;
	this.kenvector_futureDescription = { files : ["kenvector_future.ttf"], type : "font", name : "kenvector_future"};
	this.kenvector_futureName = "kenvector_future";
...
kha_FontList.prototype = {
	...
	,kenvector_futureName: null
	,kenvector_futureDescription: null
	,kenvector_futureLoad: function(done) {
		kha_Assets.loadFont("kenvector_future",function(font) {
			done();
		});
	}
	,kenvector_futureUnload: function() {
		this.kenvector_future.unload();
		this.kenvector_future = null;
	}
	,kenvector_future_thin: null
	,kenvector_future_thinName: null
	,kenvector_future_thinDescription: null
	,kenvector_future_thinLoad: function(done) {
		kha_Assets.loadFont("kenvector_future_thin",function(font) {
			done();
		});
	}
	,kenvector_future_thinUnload: function() {
		this.kenvector_future_thin.unload();
		this.kenvector_future_thin = null;
	}
...
var mint_Button = function(_options) {
	...
	this.onmousedown.listen($bind(this,this.this_onMouseDownHandler));
	this.onmouseup.listen($bind(this,this.this_onMouseUpHandler));
	var _g = 0;
	var _g1 = this.oncreate.listeners;
	while(_g < _g1.length) {
		var l = _g1[_g];
...
mint_Button.prototype = $extend(mint_Control.prototype,{
	label: null
	,options: null
	,this_onMouseDownHandler: function(e,c) {
		this.focus();
	}
	,this_onMouseUpHandler: function(e,c) {
		if(this.ishovered && this.isfocused) {
			if(this.options.onclick != null) this.options.onclick(e,c);
		}
		this.unfocus();
	}
...
mint_Checkbox.prototype = $extend(mint_Control.prototype,{
	...
	,onclick: function(_,_1) {
		if(this.ishovered && this.isfocused) this.set_state(!this.state);
		this.unfocus();
	}
...
var mint_TrackSlider = function(options) {
	this.dragY = 0;
	this.dragX = 0;
	this.dragging = false;
	this._value = 1.0;
	...
	if(options.name == null) options.name = "trackslider";
	options.name;
	if(options.mouse_input == null) options.mouse_input = true;
	options.mouse_input;
	if(options.minimumValue == null) options.minimumValue = 0.0;
	this.minimum = options.minimumValue;
	if(options.maximumValue == null) options.maximumValue = 1.0;
	this.maximum = options.maximumValue;
	if(options.value == null) options.value = this.maximum;
	this._value = options.value;
	if(options.vertical == null) options.vertical = false;
	this.vertical = options.vertical;
	this.step = options.step;
	mint_Control.call(this,options);
	options.trackOptions.parent = this;
	options.trackOptions.name = "" + this.name + ".track";
	this.track = new mint_Button(options.trackOptions);
	this.track.onmousedown.listen($bind(this,this.track_mouseDownHandler));
	this.track.onmouseup.listen($bind(this,this.track_mouseUpHandler));
	this.track.onmousemove.listen($bind(this,this.track_mouseMoveHandler));
	options.handleOptions.parent = this;
	options.handleOptions.name = "" + this.name + ".handle";
	this.handle = new mint_Button(options.handleOptions);
	this.handle.onmousedown.listen($bind(this,this.handle_mouseDownHandler));
	this.handle.onmouseup.listen($bind(this,this.handle_mouseUpHandler));
	this.handle.onmousemove.listen($bind(this,this.handle_mouseMoveHandler));
	this.renderer = this.rendering.get(mint_TrackSlider,this);
	var _g = 0;
	var _g1 = this.oncreate.listeners;
	while(_g < _g1.length) {
		var l = _g1[_g];
...
$hxClasses["mint.TrackSlider"] = mint_TrackSlider;
mint_TrackSlider.__name__ = true;
mint_TrackSlider.__super__ = mint_Control;
mint_TrackSlider.prototype = $extend(mint_Control.prototype,{
	minimum: null
	,maximum: null
	,step: null
	,vertical: null
	...
	,dragX: null
	,dragY: null
	,track_mouseDownHandler: function(event,control) {
	}
	,track_mouseUpHandler: function(event,control) {
	}
	,track_mouseMoveHandler: function(event,control) {
	}
	,handle_mouseDownHandler: function(event,control) {
		if(!this.dragging) {
			this.dragging = true;
			this.dragX = event.x;
			this.dragY = event.y;
	...
	,handle_mouseUpHandler: function(event,control) {
		if(this.dragging) this.dragging = false;
	}
	,handle_mouseMoveHandler: function(event,control) {
		if(this.dragging) this.updateValueFromMouse(event);
	}
	,updateValue: function(value) {
		value = mint_types_Helper.clamp(value,this.minimum,this.maximum);
		if(this.step != null) value = Math.round(value / this.step) * this.step;
		if(this.vertical) {
			var vrange = this.h - this.handle.h;
			this.handle.set_y_local(vrange * (value / (this.maximum - this.minimum)));
		} else {
			var hrange = this.w - this.handle.w;
			this.handle.set_x_local(hrange * (value / (this.maximum - this.minimum)));
		}
		this._value = value;
		var _g = 0;
		var _g1 = this.onchange.listeners;
		...
		haxe_Log.trace(this._value,{ fileName : "TrackSlider.hx", lineNumber : 132, className : "mint.TrackSlider", methodName : "updateValue"});
	}
	,get_value: function() {
		return this._value;
	}
	...
	,updateValueFromMouse: function(event) {
		if(!this.vertical) {
			var dx = event.x - this.x;
			if(dx < 1) dx = 1;
			if(dx >= this.w - 4) dx = this.w - 4;
			var v = (dx - 1) / (this.w - 5) * (this.maximum - this.minimum) + this.minimum;
			this.updateValue(v);
		} else {
			var dy = this.h - (event.y - this.y);
			if(dy < 1) dy = 1;
			if(dy >= this.h - 4) dy = this.h - 4;
			var v1 = (dy - 1) / (this.h - 5) * (this.maximum - this.minimum) + this.minimum;
			this.updateValue(v1);
		}
	}
	,__class__: mint_TrackSlider
});
...
mint_focus_Focus.prototype = {
	...
	,mouseup: function(e,target) {
		var wasFocused = this.canvas.get_focused();
		if(this.canvas.get_focused() != null && this.canvas.get_focused().mouse_input) this.canvas.get_focused().mouseup(e);
		if(this.marked_mouse() && wasFocused != this.canvas.get_marked()) this.canvas.get_marked().mouseup(e);
	}
...
var mintkha_G2Renderer = function(rendering,control) {
	mint_render_Render.call(this,this.khaRendering = rendering,control);
	this.khaRendering.elements.push(this);
};
$hxClasses["mintkha.G2Renderer"] = mintkha_G2Renderer;
mintkha_G2Renderer.__name__ = true;
mintkha_G2Renderer.__super__ = mint_render_Render;
mintkha_G2Renderer.prototype = $extend(mint_render_Render.prototype,{
	khaRendering: null
	,mydepth: null
	,renderG2: function(graphics) {
	}
	,__class__: mintkha_G2Renderer
});
var mintkha_ButtonRenderer = function(rendering,control) {
	var _g = this;
	mintkha_G2Renderer.call(this,rendering,this.button = control);
	this.options = control.options.options;
	this.stateSkin = this.options.defaultSkin;
	this.button.onmouseenter.listen(function(e,c) {
		if(_g.button.isfocused) {
			_g.stateSkin = _g.options.downSkin;
			(js_Boot.__cast(_g.button.label.renderer , mintkha_LabelRenderer)).stateSkin = control.options.options.label.downSkin;
		} else {
			_g.stateSkin = _g.options.highlightSkin;
			(js_Boot.__cast(_g.button.label.renderer , mintkha_LabelRenderer)).stateSkin = control.options.options.label.highlightSkin;
		}
	});
	this.button.onmouseleave.listen(function(e1,c1) {
		if(_g.button.isfocused) {
			...
			_g.stateSkin = _g.options.defaultSkin;
			(js_Boot.__cast(_g.button.label.renderer , mintkha_LabelRenderer)).stateSkin = control.options.options.label.defaultSkin;
		}
	});
...
$hxClasses["mintkha.ButtonRenderer"] = mintkha_ButtonRenderer;
mintkha_ButtonRenderer.__name__ = true;
mintkha_ButtonRenderer.__super__ = mintkha_G2Renderer;
mintkha_ButtonRenderer.prototype = $extend(mintkha_G2Renderer.prototype,{
	button: null
	,options: null
	,stateSkin: null
	,renderG2: function(graphics) {
		this.stateSkin.drawG2(graphics,this.control.x,this.control.y,this.control.w,this.control.h);
	}
	,ondepth: function(depth) {
		this.mydepth = depth;
		this.khaRendering.sortByDepth();
	}
	,__class__: mintkha_ButtonRenderer
});
var mintkha_CanvasRenderer = function(rendering,control) {
	mintkha_G2Renderer.call(this,rendering,this.canvas = control);
};
$hxClasses["mintkha.CanvasRenderer"] = mintkha_CanvasRenderer;
mintkha_CanvasRenderer.__name__ = true;
mintkha_CanvasRenderer.__super__ = mintkha_G2Renderer;
mintkha_CanvasRenderer.prototype = $extend(mintkha_G2Renderer.prototype,{
	canvas: null
	,ondepth: function(depth) {
		this.mydepth = depth;
		this.khaRendering.sortByDepth();
	}
	,__class__: mintkha_CanvasRenderer
});
var mintkha_CheckboxRenderer = function(rendering,control) {
	mintkha_G2Renderer.call(this,rendering,this.checkbox = control);
	this.options = control.options.options;
	this.stateSkin = this.options.defaultSkin;
	this.checkbox.oncreate.listen($bind(this,this.checkbox_onCreateHandler));
};
$hxClasses["mintkha.CheckboxRenderer"] = mintkha_CheckboxRenderer;
mintkha_CheckboxRenderer.__name__ = true;
mintkha_CheckboxRenderer.__super__ = mintkha_G2Renderer;
mintkha_CheckboxRenderer.prototype = $extend(mintkha_G2Renderer.prototype,{
	checkbox: null
	,options: null
	,stateSkin: null
	,checkbox_onCreateHandler: function() {
		var _g = this;
		this.checkbox.onmouseenter.listen(function(e,c) {
			if(_g.checkbox.isfocused) if(_g.checkbox.state) _g.stateSkin = _g.options.selectedDownSkin; else _g.stateSkin = _g.options.downSkin; else if(_g.checkbox.state) _g.stateSkin = _g.options.selectedHighlightSkin; else _g.stateSkin = _g.options.highlightSkin;
		});
		this.checkbox.onmouseleave.listen(function(e1,c1) {
			if(_g.checkbox.isfocused) if(_g.checkbox.state) _g.stateSkin = _g.options.selectedHighlightSkin; else _g.stateSkin = _g.options.highlightSkin; else if(_g.checkbox.state) _g.stateSkin = _g.options.selectedDefaultSkin; else _g.stateSkin = _g.options.defaultSkin;
		});
		this.checkbox.onmousedown.listen(function(e2,c2) {
			if(_g.checkbox.state) _g.stateSkin = _g.options.selectedDownSkin; else _g.stateSkin = _g.options.downSkin;
		});
		this.checkbox.onmouseup.listen(function(e3,c3) {
			if(_g.checkbox.ishovered) if(_g.checkbox.state) _g.stateSkin = _g.options.selectedHighlightSkin; else _g.stateSkin = _g.options.highlightSkin; else if(_g.checkbox.state) _g.stateSkin = _g.options.selectedDefaultSkin; else _g.stateSkin = _g.options.defaultSkin;
		});
		this.checkbox.onchange.listen($bind(this,this.checkbox_onChangeHandler));
		this.checkbox_onChangeHandler(this.checkbox.state,false);
	}
	,checkbox_onChangeHandler: function(newState,_) {
		if(this.checkbox.state) this.stateSkin = this.options.selectedDefaultSkin; else this.stateSkin = this.options.defaultSkin;
	}
	,renderG2: function(graphics) {
		this.stateSkin.drawG2(graphics,this.control.x,this.control.y,this.control.w,this.control.h);
	}
	...
	,__class__: mintkha_CheckboxRenderer
});
var mintkha_G2Rendering = function() {
	this.elements = [];
	mint_render_Rendering.call(this);
};
$hxClasses["mintkha.G2Rendering"] = mintkha_G2Rendering;
mintkha_G2Rendering.__name__ = true;
mintkha_G2Rendering.__super__ = mint_render_Rendering;
mintkha_G2Rendering.prototype = $extend(mint_render_Rendering.prototype,{
	elements: null
	,renderG2: function(graphics) {
		var _g = 0;
	...
	,get: function(type,control) {
		return (function($this) {
			...
			switch(type) {
			case mint_Canvas:
				$r = new mintkha_CanvasRenderer($this,control);
				break;
			case mint_Label:
				$r = new mintkha_LabelRenderer($this,control);
				break;
			case mint_Button:
				$r = new mintkha_ButtonRenderer($this,control);
				break;
			case mint_Checkbox:
				$r = new mintkha_CheckboxRenderer($this,control);
				break;
			case mint_Progress:
				$r = new mintkha_ProgressRenderer($this,control);
				break;
			case mint_TrackSlider:
				$r = new mintkha_TrackSliderRenderer($this,control);
				break;
			default:
				$r = null;
			}
	...
	,sortByDepth: function() {
		this.elements.sort(function(l,r) {
			if(l.mydepth < r.mydepth) return -1; else return 1;
		});
		var xxx;
		xxx = 666;
	}
	,__class__: mintkha_G2Rendering
});
var mintkha_LabelRenderer = function(rendering,control) {
	mintkha_G2Renderer.call(this,rendering,this.label = control);
	this.options = control.options.options;
	this.stateSkin = this.options.defaultSkin;
};
$hxClasses["mintkha.LabelRenderer"] = mintkha_LabelRenderer;
mintkha_LabelRenderer.__name__ = true;
mintkha_LabelRenderer.__super__ = mintkha_G2Renderer;
mintkha_LabelRenderer.prototype = $extend(mintkha_G2Renderer.prototype,{
	label: null
	,options: null
	,stateSkin: null
	,renderG2: function(graphics) {
		if(this.stateSkin != null) this.stateSkin.drawG2(graphics,this.control.x,this.control.y,this.control.w,this.control.h);
	}
	,ondepth: function(depth) {
		this.mydepth = depth;
		this.khaRendering.sortByDepth();
	}
	,__class__: mintkha_LabelRenderer
});
var mintkha_ProgressRenderer = function(rendering,control) {
	mintkha_G2Renderer.call(this,rendering,this.progress = control);
	this.options = control.options.options;
};
$hxClasses["mintkha.ProgressRenderer"] = mintkha_ProgressRenderer;
mintkha_ProgressRenderer.__name__ = true;
mintkha_ProgressRenderer.__super__ = mintkha_G2Renderer;
mintkha_ProgressRenderer.prototype = $extend(mintkha_G2Renderer.prototype,{
	progress: null
	,options: null
	,renderG2: function(graphics) {
		this.options.backgroundSkin.drawG2(graphics,this.control.x,this.control.y,this.control.w,this.control.h);
		var pl = this.options.paddingLeft;
		var pt = this.options.paddingTop;
		var pr = this.options.paddingRight;
		var pb = this.options.paddingBottom;
		var maxWidth = this.control.w - pr - pl;
		var actualWidth = maxWidth * this.progress.progress;
		this.options.fillSkin.drawG2(graphics,this.control.x + pl,this.control.y + pt,actualWidth,this.control.h - pt - pb);
	}
	,ondepth: function(depth) {
		this.mydepth = depth;
		this.khaRendering.sortByDepth();
	}
	,__class__: mintkha_ProgressRenderer
});
var mintkha_ThemeTools = function() { };
$hxClasses["mintkha.ThemeTools"] = mintkha_ThemeTools;
mintkha_ThemeTools.__name__ = true;
mintkha_ThemeTools.textureSkin = function(texture,atlasModel,id,offset) {
	var region1 = Lambda.find(atlasModel.regions,function(region) {
		return region.id == id;
	});
	if(region1 == null) {
		haxe_Log.trace("region \"" + id + "\" not found in atlas",{ fileName : "ThemeTools.hx", lineNumber : 14, className : "mintkha.ThemeTools", methodName : "textureSkin"});
		return null;
	}
	return new mintkha_skin_AtlasTextureSkin(texture,region1.x,region1.y,region1.width,region1.height,offset);
};
mintkha_ThemeTools.nineSliceSkin = function(texture,atlasModel,id,grid,offset) {
	var region1 = Lambda.find(atlasModel.regions,function(region) {
		return region.id == id;
	});
	if(region1 == null) {
		haxe_Log.trace("region \"" + id + "\" not found in atlas",{ fileName : "ThemeTools.hx", lineNumber : 25, className : "mintkha.ThemeTools", methodName : "nineSliceSkin"});
		return null;
	}
	return new mintkha_skin_NineSliceAtlasTextureSkin(texture,region1.x,region1.y,region1.width,region1.height,grid,offset);
};
var mintkha_TrackSliderRenderer = function(rendering,control) {
	mintkha_G2Renderer.call(this,rendering,this.slider = control);
};
$hxClasses["mintkha.TrackSliderRenderer"] = mintkha_TrackSliderRenderer;
mintkha_TrackSliderRenderer.__name__ = true;
mintkha_TrackSliderRenderer.__super__ = mintkha_G2Renderer;
mintkha_TrackSliderRenderer.prototype = $extend(mintkha_G2Renderer.prototype,{
	slider: null
	,__class__: mintkha_TrackSliderRenderer
});
var mintkha_skin_AtlasTextureSkin = function(texture,x,y,w,h,offset) {
...
$hxClasses["mintkha.skin.AtlasTextureSkin"] = mintkha_skin_AtlasTextureSkin;
mintkha_skin_AtlasTextureSkin.__name__ = true;
mintkha_skin_AtlasTextureSkin.prototype = {
	texture: null
	,x: null
	,y: null
	,w: null
	,h: null
	,offset: null
	,drawG2: function(g,controlX,controlY,controlWidth,controlHeight) {
		var oh;
		if(this.offset != null) oh = this.offset.horizontal; else oh = 0;
		var ov;
		if(this.offset != null) ov = this.offset.vertical; else ov = 0;
		g.drawScaledSubImage(this.texture,this.x,this.y,this.w,this.h,controlX + oh,controlY + ov,controlWidth,controlHeight);
	}
	,__class__: mintkha_skin_AtlasTextureSkin
};
var mintkha_skin_ColoredRectSkin = function(color) {
	this.color = color;
};
$hxClasses["mintkha.skin.ColoredRectSkin"] = mintkha_skin_ColoredRectSkin;
mintkha_skin_ColoredRectSkin.__name__ = true;
mintkha_skin_ColoredRectSkin.prototype = {
	color: null
	,drawG2: function(g,cx,cy,cw,ch) {
		var colorGuard = g.get_color();
		g.set_color(this.color);
		kha_graphics2_GraphicsExtension.fillPolygon(g,cx,cy,[new kha_math_Vector2(0,0),new kha_math_Vector2(cw,0),new kha_math_Vector2(cw,ch),new kha_math_Vector2(0,ch)]);
		g.set_color(colorGuard);
	}
	,__class__: mintkha_skin_ColoredRectSkin
};
var mintkha_skin_LabelSkin = function(color,font,fontSize,text,offset) {
	this.color = color;
	this.font = font;
...
$hxClasses["mintkha.skin.LabelSkin"] = mintkha_skin_LabelSkin;
mintkha_skin_LabelSkin.__name__ = true;
mintkha_skin_LabelSkin.prototype = {
	color: null
	,font: null
	,fontSize: null
	,text: null
	...
	,drawG2: function(g,cx,cy,cw,ch) {
		...
		g.drawString(this.text,cx + oh,cy + ov);
		g.set_color(colorGuard);
	}
	,__class__: mintkha_skin_LabelSkin
};
var mintkha_skin_NineSliceAtlasTextureSkin = function(texture,x,y,w,h,grid,offset) {
	this.texture = texture;
	this.x = x;
	this.y = y;
	this.w = w;
...
$hxClasses["mintkha.skin.NineSliceAtlasTextureSkin"] = mintkha_skin_NineSliceAtlasTextureSkin;
mintkha_skin_NineSliceAtlasTextureSkin.__name__ = true;
mintkha_skin_NineSliceAtlasTextureSkin.prototype = {
	texture: null
	,x: null
	,y: null
	,w: null
	...
	,offset: null
	,drawG2: function(g,cx,cy,cw,ch) {
		var leftWidth = this.grid.x;
		var centerWidth = this.grid.w;
		var rightWidth = this.w - this.grid.w - this.grid.x;
		var topHeight = this.grid.y;
		var middleHeight = this.grid.h;
		var bottomHeight = this.h - this.grid.h - this.grid.y;
		var oh;
		if(this.offset != null) oh = this.offset.horizontal; else oh = 0;
		var ov;
		if(this.offset != null) ov = this.offset.vertical; else ov = 0;
		g.drawScaledSubImage(this.texture,this.x,this.y,leftWidth,topHeight,cx + oh,cy + ov,leftWidth,topHeight);
		g.drawScaledSubImage(this.texture,this.x + leftWidth,this.y,centerWidth,topHeight,cx + oh + leftWidth,cy + ov,cw - leftWidth - rightWidth,topHeight);
		g.drawScaledSubImage(this.texture,this.x + leftWidth + centerWidth,this.y,rightWidth,topHeight,cx + oh + cw - rightWidth,cy + ov,rightWidth,topHeight);
		var msy = this.y + topHeight;
		g.drawScaledSubImage(this.texture,this.x,msy,leftWidth,middleHeight,cx + oh,cy + ov + topHeight,leftWidth,ch - topHeight - bottomHeight - ov);
		g.drawScaledSubImage(this.texture,this.x + leftWidth,msy,centerWidth,middleHeight,cx + oh + leftWidth,cy + ov + topHeight,cw - leftWidth - rightWidth,ch - topHeight - bottomHeight - ov);
		g.drawScaledSubImage(this.texture,this.x + leftWidth + centerWidth,msy,rightWidth,middleHeight,cx + oh + cw - rightWidth,cy + ov + topHeight,rightWidth,ch - topHeight - bottomHeight - ov);
		var bsy = this.y + topHeight + middleHeight;
		g.drawScaledSubImage(this.texture,this.x,bsy,leftWidth,bottomHeight,cx + oh,cy + ch - bottomHeight,leftWidth,bottomHeight);
		g.drawScaledSubImage(this.texture,this.x + leftWidth,bsy,centerWidth,bottomHeight,cx + oh + leftWidth,cy + ch - bottomHeight,cw - leftWidth - rightWidth,bottomHeight);
		g.drawScaledSubImage(this.texture,this.x + leftWidth + centerWidth,bsy,rightWidth,bottomHeight,cx + oh + cw - rightWidth,cy + ch - bottomHeight,rightWidth,bottomHeight);
	}
	,__class__: mintkha_skin_NineSliceAtlasTextureSkin
};
var mintkha_support_Offset = function(h,v) {
	if(v == null) v = 0.0;
	if(h == null) h = 0.0;
	this.horizontal = h;
	this.vertical = v;
};
$hxClasses["mintkha.support.Offset"] = mintkha_support_Offset;
mintkha_support_Offset.__name__ = true;
mintkha_support_Offset.prototype = {
	horizontal: null
	,vertical: null
	,__class__: mintkha_support_Offset
};
var mintkha_support_Rectangle = function(x,y,w,h) {
	if(h == null) h = 0.0;
	if(w == null) w = 0.0;
	if(y == null) y = 0.0;
	if(x == null) x = 0.0;
...
$hxClasses["mintkha.support.Rectangle"] = mintkha_support_Rectangle;
mintkha_support_Rectangle.__name__ = true;
mintkha_support_Rectangle.prototype = {
	x: null
	,y: null
	,w: null
	,h: null
	,__class__: mintkha_support_Rectangle
};
var mintkha_support_StarlingAtlasXmlReader = function() { };
$hxClasses["mintkha.support.StarlingAtlasXmlReader"] = mintkha_support_StarlingAtlasXmlReader;
mintkha_support_StarlingAtlasXmlReader.__name__ = true;
mintkha_support_StarlingAtlasXmlReader.read = function(xml) {
	...
	if((function($this) {
		...
		haxe_Log.trace("not a starling texture atlas",{ fileName : "StarlingAtlasXmlReader.hx", lineNumber : 11, className : "mintkha.support.StarlingAtlasXmlReader", methodName : "read"});
		return null;
	}
	var regions = [];
	...
	while( $it0.hasNext() ) {
		...
		switch(_g) {
		case "SubTexture":
			regions.push(mintkha_support_StarlingAtlasXmlReader.readSubTexture(child));
			break;
		default:
			haxe_Log.trace("unhandled node " + (function($this) {
				var $r;
				if(child.nodeType != Xml.Element) throw new js__$Boot_HaxeError("Bad node type, expected Element but found " + child.nodeType);
				$r = child.nodeName;
				return $r;
			}(this)),{ fileName : "StarlingAtlasXmlReader.hx", lineNumber : 20, className : "mintkha.support.StarlingAtlasXmlReader", methodName : "read"});
		}
	}
	return { regions : regions};
};
mintkha_support_StarlingAtlasXmlReader.readSubTexture = function(xml) {
	return { id : xml.get("name"), x : Std.parseFloat(xml.get("x")), y : Std.parseFloat(xml.get("y")), width : Std.parseFloat(xml.get("width")), height : Std.parseFloat(xml.get("height"))};
};
mintkha_support_StarlingAtlasXmlReader._string = function(xml,name) {
	return xml.get(name);
};
mintkha_support_StarlingAtlasXmlReader._float = function(xml,name) {
	return Std.parseFloat(xml.get(name));
};
var mintkha_theme_KenneyBasicTheme = function(color) {
	this.sliderTrackDefaultSkinId = "grey_sliderHorizontal";
	this.sliderHandleDisabledSkinId = "grey_sliderDown";
	this.sliderHandleDownSkinId = "green_sliderDown";
	this.sliderHandleHoverSkinId = "yellow_sliderDown";
	this.sliderHandleUpSkinId = "blue_sliderDown";
	this.checkSelectedDisabledSkinId = "grey_boxCheckmark";
	this.checkSelectedDownSkinId = "green_boxCross";
	this.checkSelectedHoverSkinId = "yellow_boxCheckmark";
	this.checkSelectedUpSkinId = "blue_boxCheckmark";
	this.checkDisabledSkinId = "grey_boxCross";
	this.checkDownSkinId = "green_boxCheckmark";
	this.checkHoverSkinId = "yellow_boxCross";
	this.checkUpSkinId = "blue_boxCross";
	this.checkNineSliceGrid = new mintkha_support_Rectangle(10,10,18,18);
	this.buttonDownOffset = new mintkha_support_Offset(0,5);
	this.buttonDisabledSkinId = "grey_button11";
	this.buttonDownSkinId = "green_button10";
	this.buttonHoverSkinId = "yellow_button09";
	this.buttonUpSkinId = "blue_button09";
	this.buttonNineSliceGrid = new mintkha_support_Rectangle(6,22,38,1);
};
$hxClasses["mintkha.theme.KenneyBasicTheme"] = mintkha_theme_KenneyBasicTheme;
mintkha_theme_KenneyBasicTheme.__name__ = true;
mintkha_theme_KenneyBasicTheme.prototype = {
	buttonNineSliceGrid: null
	,buttonUpSkinId: null
	,buttonHoverSkinId: null
	,buttonDownSkinId: null
	,buttonDisabledSkinId: null
	,buttonDownOffset: null
	,checkNineSliceGrid: null
	,checkUpSkinId: null
	,checkHoverSkinId: null
	,checkDownSkinId: null
	,checkDisabledSkinId: null
	,checkSelectedUpSkinId: null
	,checkSelectedHoverSkinId: null
	,checkSelectedDownSkinId: null
	,checkSelectedDisabledSkinId: null
	,sliderHandleUpSkinId: null
	,sliderHandleHoverSkinId: null
	,sliderHandleDownSkinId: null
	,sliderHandleDisabledSkinId: null
	,sliderTrackDefaultSkinId: null
	,__class__: mintkha_theme_KenneyBasicTheme
};
...
mintkha_theme_KenneyBasicTheme.redTheme = new mintkha_theme_KenneyBasicTheme("red");
mintkha_theme_KenneyBasicTheme.greenTheme = new mintkha_theme_KenneyBasicTheme("green");
mintkha_theme_KenneyBasicTheme.blueTheme = new mintkha_theme_KenneyBasicTheme("blue");
mintkha_theme_KenneyBasicTheme.yellowTheme = new mintkha_theme_KenneyBasicTheme("yellow");
Main.main();
